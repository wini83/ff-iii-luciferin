...
from openapi_client.models.recurrence_repetition_update import (
    RecurrenceRepetitionUpdate,
)
from openapi_client.models.recurrence_transaction_update import (
...
class RecurrenceUpdate(BaseModel):
    ...
    first_date: Optional[date] = Field(
        default=None, description="First time the recurring transaction will fire."
    )
        ...
        _obj = RecurrenceUpdate.parse_obj(
            {
                ...
                "repetitions": (
                    [
                        RecurrenceRepetitionUpdate.from_dict(_item)
                ...
                "transactions": (
                    [
                        RecurrenceTransactionUpdate.from_dict(_item)
