...
class RuleGroupUpdate(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RuleGroupUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RuleGroupUpdate:
        """Create an instance of RuleGroupUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RuleGroupUpdate.parse_obj(obj)

        _obj = RuleGroupUpdate.parse_obj(
            {
                "title": obj.get("title"),
