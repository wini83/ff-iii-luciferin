...
from openapi_client.models.currency_exchange_properties import (
        ...
        _obj = CurrencyExchangeRateRead.parse_obj(
            {
                ...
                "id": obj.get("id"),
                "attributes": (
                    CurrencyExchangeProperties.from_dict(obj.get("attributes"))
                    if obj.get("attributes") is not None
                    else None
                ),
                "links": (
                    ObjectLink.from_dict(obj.get("links"))
