...
class InsightGroupEntry(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InsightGroupEntry:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InsightGroupEntry:
        """Create an instance of InsightGroupEntry from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InsightGroupEntry.parse_obj(obj)

        _obj = InsightGroupEntry.parse_obj(
            {
                "id": obj.get("id"),
                "name": obj.get("name"),
