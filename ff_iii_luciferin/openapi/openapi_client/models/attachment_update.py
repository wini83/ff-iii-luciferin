...
class AttachmentUpdate(BaseModel):
    ...
    __properties = ["filename", "title", "notes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttachmentUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttachmentUpdate:
        """Create an instance of AttachmentUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AttachmentUpdate.parse_obj(obj)

        _obj = AttachmentUpdate.parse_obj(
            {
