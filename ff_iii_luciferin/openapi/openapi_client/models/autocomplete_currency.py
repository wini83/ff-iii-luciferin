...
class AutocompleteCurrency(BaseModel):
    ...
    id: StrictStr = Field(...)
    name: StrictStr = Field(default=..., description="Currency name.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AutocompleteCurrency:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AutocompleteCurrency:
        """Create an instance of AutocompleteCurrency from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AutocompleteCurrency.parse_obj(obj)

        _obj = AutocompleteCurrency.parse_obj(
            {
                "id": obj.get("id"),
                "name": obj.get("name"),
                "code": obj.get("code"),
