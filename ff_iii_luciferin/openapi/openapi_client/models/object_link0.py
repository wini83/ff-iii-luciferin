...
class ObjectLink0(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectLink0:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ObjectLink0:
        """Create an instance of ObjectLink0 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectLink0.parse_obj(obj)

        _obj = ObjectLink0.parse_obj({"rel": obj.get("rel"), "uri": obj.get("uri")})
        return _obj
