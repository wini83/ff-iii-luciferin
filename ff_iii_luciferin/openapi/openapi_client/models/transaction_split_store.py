...
class TransactionSplitStore(BaseModel):
    ...
    currency_id: Optional[StrictStr] = Field(default=None, description="Currency ID. Default is the source account's currency, or the user's financial administration's currency. The value you submit may be overruled by the source or destination account.", json_schema_extra={"examples": ["12"]})
    currency_code: Optional[StrictStr] = Field(default=None, description="Currency code. Default is the source account's currency, or the user's financial administration's primary currency. The value you submit may be overruled by the source or destination account.", json_schema_extra={"examples": ["EUR"]})
    ...
    bill_id: Optional[StrictStr] = Field(default=None, description="Optional. Use either this or the bill_name", json_schema_extra={"examples": ["112"]})
    ...
    __properties: ClassVar[List[str]] = ["type", "date", "amount", "description", "order", "currency_id", "currency_code", "foreign_amount", "foreign_currency_id", "foreign_currency_code", "budget_id", "budget_name", "category_id", "category_name", "source_id", "source_name", "destination_id", "destination_name", "reconciled", "piggy_bank_id", "piggy_bank_name", "bill_id", "bill_name", "tags", "notes", "internal_reference", "external_id", "external_url", "sepa_cc", "sepa_ct_op", "sepa_ct_id", "sepa_db", "sepa_country", "sepa_ep", "sepa_ci", "sepa_batch_id", "interest_date", "book_date", "process_date", "due_date", "payment_date", "invoice_date"]
