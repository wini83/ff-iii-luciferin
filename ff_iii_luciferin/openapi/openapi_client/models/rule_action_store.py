...
class RuleActionStore(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RuleActionStore:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RuleActionStore:
        """Create an instance of RuleActionStore from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RuleActionStore.parse_obj(obj)

        _obj = RuleActionStore.parse_obj(
            {
                "type": obj.get("type"),
                "value": obj.get("value"),
                "order": obj.get("order"),
