...
class RuleTriggerUpdate(BaseModel):
    ...
    active: Optional[StrictBool] = Field(
        default=None, description="If the trigger is active."
    )
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RuleTriggerUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RuleTriggerUpdate:
        """Create an instance of RuleTriggerUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RuleTriggerUpdate.parse_obj(obj)

        _obj = RuleTriggerUpdate.parse_obj(
            {
                "type": obj.get("type"),
                "value": obj.get("value"),
                "order": obj.get("order"),
