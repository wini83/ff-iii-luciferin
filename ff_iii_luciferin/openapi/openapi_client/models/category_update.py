...
class CategoryUpdate(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CategoryUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CategoryUpdate:
        """Create an instance of CategoryUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CategoryUpdate.parse_obj(obj)

        _obj = CategoryUpdate.parse_obj(
