...
class BillProperties(BaseModel):
    ...
    paid_dates: Optional[List[BillPropertiesPaidDatesInner]] = Field(
        default=None,
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if (
            ...
            and "next_expected_match" in self.model_fields_set
        ):
        ...
        if (
            ...
            and "next_expected_match_diff" in self.model_fields_set
        ):
