...
class TransactionStore(BaseModel):
    ...
    error_if_duplicate_hash: Optional[StrictBool] = Field(
        default=None, description="Break if the submitted transaction exists already."
    )
    ...
    transactions: conlist(TransactionSplitStore) = Field(...)
    __properties = [
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionStore:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionStore:
        """Create an instance of TransactionStore from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionStore.parse_obj(obj)

        _obj = TransactionStore.parse_obj(
            {
                ...
                "transactions": (
                    [
                        TransactionSplitStore.from_dict(_item)
