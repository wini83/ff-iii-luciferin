...
class AutocompleteRule(BaseModel):
    ...
    name: StrictStr = Field(
        default=..., description="Name of the rule found by an auto-complete search."
    )
    description: Optional[StrictStr] = Field(
        default=None, description="Description of the rule found by auto-complete."
    )
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AutocompleteRule:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AutocompleteRule:
        """Create an instance of AutocompleteRule from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AutocompleteRule.parse_obj(obj)

        _obj = AutocompleteRule.parse_obj(
            {
                "id": obj.get("id"),
                "name": obj.get("name"),
