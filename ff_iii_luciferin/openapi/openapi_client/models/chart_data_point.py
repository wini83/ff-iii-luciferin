...
class ChartDataPoint(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChartDataPoint:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChartDataPoint:
        """Create an instance of ChartDataPoint from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChartDataPoint.parse_obj(obj)

        _obj = ChartDataPoint.parse_obj({"key": obj.get("key")})
        return _obj
