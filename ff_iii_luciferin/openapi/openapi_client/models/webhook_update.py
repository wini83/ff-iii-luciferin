...
class WebhookUpdate(BaseModel):
    ...
    title: Optional[StrictStr] = Field(
        default=None, description="A title for the webhook for easy recognition."
    )
    ...
    url: Optional[StrictStr] = Field(
        default=None, description="The URL of the webhook. Has to start with `https`."
    )
    __properties = [
        "active",
        "title",
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookUpdate:
        """Create an instance of WebhookUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookUpdate.parse_obj(obj)

        _obj = WebhookUpdate.parse_obj(
            {
