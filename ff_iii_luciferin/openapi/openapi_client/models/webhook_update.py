...
class WebhookUpdate(BaseModel):
    ...
    triggers: Optional[
        Annotated[List[WebhookTrigger], Field(min_length=1, max_length=3)]
    ] = None
    responses: Optional[
        Annotated[List[WebhookResponse], Field(min_length=1, max_length=1)]
    ] = None
    deliveries: Optional[
        Annotated[List[WebhookDelivery], Field(min_length=1, max_length=1)]
    ] = None
