...
class LinkTypeUpdate(BaseModel):
    ...
    __properties = ["name", "inward", "outward"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LinkTypeUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LinkTypeUpdate:
        """Create an instance of LinkTypeUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LinkTypeUpdate.parse_obj(obj)

        _obj = LinkTypeUpdate.parse_obj(
            {
                "name": obj.get("name"),
