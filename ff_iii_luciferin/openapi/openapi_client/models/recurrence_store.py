...
class RecurrenceStore(BaseModel):
    ...
    title: StrictStr = Field(json_schema_extra={"examples": ["Rent"]})
    ...
    first_date: date = Field(description="First time the recurring transaction will fire. Must be after today.", json_schema_extra={"examples": ["2026-07-31"]})
    repeat_until: Optional[date] = Field(description="Date until the recurring transaction can fire. Use either this field or repetitions.", json_schema_extra={"examples": ["2026-07-31"]})
