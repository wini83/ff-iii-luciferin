...
class TransactionSplitUpdate(BaseModel):
    ...
    """ # noqa: E501
    transaction_journal_id: Optional[StrictStr] = Field(default=None, description="Transaction journal ID of current transaction (split).", json_schema_extra={"examples": ["123"]})
    type: Optional[TransactionTypeProperty] = None
    var_date: Optional[datetime] = Field(default=None, description="Date of the transaction", alias="date", json_schema_extra={"examples": ["2026-07-01T00:00:00Z"]})
    amount: Optional[StrictStr] = Field(default=None, description="Amount of the transaction.", json_schema_extra={"examples": ["123.45"]})
    description: Optional[StrictStr] = Field(default=None, description="Description of the transaction.", json_schema_extra={"examples": ["Vegetables"]})
    ...
    currency_id: Optional[StrictStr] = Field(default=None, description="Currency ID. Default is the source account's currency, or the user's financial administration's primary currency. Can be used instead of currency_code.", json_schema_extra={"examples": ["12"]})
    currency_code: Optional[StrictStr] = Field(default=None, description="Currency code. Default is the source account's currency, or the user's financial administration's primary currency. Can be used instead of currency_id.", json_schema_extra={"examples": ["EUR"]})
    currency_symbol: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["$"]})
    currency_name: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Euro"]})
    ...
    foreign_amount: Optional[StrictStr] = Field(default=None, description="The amount in a foreign currency.", json_schema_extra={"examples": ["123.45"]})
    foreign_currency_id: Optional[StrictStr] = Field(default=None, description="Currency ID of the foreign currency. Default is null. Is required when you submit a foreign amount.", json_schema_extra={"examples": ["17"]})
    foreign_currency_code: Optional[StrictStr] = Field(default=None, description="Currency code of the foreign currency. Default is NULL. Can be used instead of the foreign_currency_id, but this or the ID is required when submitting a foreign amount.", json_schema_extra={"examples": ["USD"]})
    ...
    source_id: Optional[StrictStr] = Field(default=None, description="ID of the source account. For a withdrawal or a transfer, this must always be an asset account. For deposits, this must be a revenue account.", json_schema_extra={"examples": ["2"]})
    ...
    destination_id: Optional[StrictStr] = Field(default=None, description="ID of the destination account. For a deposit or a transfer, this must always be an asset account. For withdrawals this must be an expense account.", json_schema_extra={"examples": ["2"]})
    ...
    bill_id: Optional[StrictStr] = Field(default=None, description="Optional. Use either this or the bill_name", json_schema_extra={"examples": ["111"]})
    bill_name: Optional[StrictStr] = Field(default=None, description="Optional. Use either this or the bill_id", json_schema_extra={"examples": ["Monthly rent"]})
    ...
    __properties: ClassVar[List[str]] = ["transaction_journal_id", "type", "date", "amount", "description", "order", "currency_id", "currency_code", "currency_symbol", "currency_name", "currency_decimal_places", "foreign_amount", "foreign_currency_id", "foreign_currency_code", "foreign_currency_symbol", "foreign_currency_decimal_places", "budget_id", "budget_name", "category_id", "category_name", "source_id", "source_name", "source_iban", "destination_id", "destination_name", "destination_iban", "reconciled", "bill_id", "bill_name", "tags", "notes", "internal_reference", "external_id", "external_url", "sepa_cc", "sepa_ct_op", "sepa_ct_id", "sepa_db", "sepa_country", "sepa_ep", "sepa_ci", "sepa_batch_id", "interest_date", "book_date", "process_date", "due_date", "payment_date", "invoice_date"]
