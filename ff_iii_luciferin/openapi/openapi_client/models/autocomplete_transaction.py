...
class AutocompleteTransaction(BaseModel):
    ...
    name: StrictStr = Field(description="Transaction description", json_schema_extra={"examples": ["Transaction"]})
    description: StrictStr = Field(description="Transaction description", json_schema_extra={"examples": ["Transaction"]})
