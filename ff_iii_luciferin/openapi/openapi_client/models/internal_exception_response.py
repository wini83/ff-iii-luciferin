...
class InternalExceptionResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InternalExceptionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InternalExceptionResponse:
        """Create an instance of InternalExceptionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InternalExceptionResponse.parse_obj(obj)

        _obj = InternalExceptionResponse.parse_obj(
