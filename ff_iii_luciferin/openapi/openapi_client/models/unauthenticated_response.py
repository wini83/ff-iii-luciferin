...
class UnauthenticatedResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UnauthenticatedResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UnauthenticatedResponse:
        """Create an instance of UnauthenticatedResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UnauthenticatedResponse.parse_obj(obj)

        _obj = UnauthenticatedResponse.parse_obj(
