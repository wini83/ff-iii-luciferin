...
class AutocompleteBill(BaseModel):
    ...
    name: StrictStr = Field(
        default=..., description="Name of the bill found by an auto-complete search."
    )
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AutocompleteBill:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AutocompleteBill:
        """Create an instance of AutocompleteBill from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AutocompleteBill.parse_obj(obj)

        _obj = AutocompleteBill.parse_obj(
