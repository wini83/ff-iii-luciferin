...
class RuleUpdate(BaseModel):
    ...
    __properties = ["title", "description", "rule_group_id", "order", "trigger", "active", "strict", "stop_processing", "triggers", "actions"]
    ...
    def from_dict(cls, obj: dict) -> RuleUpdate:
        ...
        _obj = RuleUpdate.parse_obj({
            ...
            "triggers": [RuleTriggerUpdate.from_dict(_item) for _item in obj.get("triggers")] if obj.get("triggers") is not None else None,
            "actions": [RuleActionUpdate.from_dict(_item) for _item in obj.get("actions")] if obj.get("actions") is not None else None
        })
        return _obj
