...
class AttachmentSingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttachmentSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttachmentSingle:
        """Create an instance of AttachmentSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AttachmentSingle.parse_obj(obj)

        _obj = AttachmentSingle.parse_obj({
            "data": AttachmentRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
