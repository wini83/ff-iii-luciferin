...
class CurrencySingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CurrencySingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CurrencySingle:
        """Create an instance of CurrencySingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CurrencySingle.parse_obj(obj)

        _obj = CurrencySingle.parse_obj({
            "data": CurrencyRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
