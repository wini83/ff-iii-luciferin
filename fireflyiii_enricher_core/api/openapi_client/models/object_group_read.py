...
class ObjectGroupRead(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectGroupRead:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ObjectGroupRead:
        """Create an instance of ObjectGroupRead from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectGroupRead.parse_obj(obj)

        _obj = ObjectGroupRead.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": ObjectGroup.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
