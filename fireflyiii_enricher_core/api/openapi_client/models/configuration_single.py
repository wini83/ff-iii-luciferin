...
class ConfigurationSingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigurationSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigurationSingle:
        """Create an instance of ConfigurationSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigurationSingle.parse_obj(obj)

        _obj = ConfigurationSingle.parse_obj({
            "data": Configuration.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
