...
class PreferenceUpdate(BaseModel):
    ...
    PreferenceUpdate
    """
    data: PolymorphicProperty = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PreferenceUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PreferenceUpdate:
        """Create an instance of PreferenceUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PreferenceUpdate.parse_obj(obj)

        _obj = PreferenceUpdate.parse_obj({
            "data": PolymorphicProperty.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
