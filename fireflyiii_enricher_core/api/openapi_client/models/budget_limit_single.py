...
class BudgetLimitSingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BudgetLimitSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BudgetLimitSingle:
        """Create an instance of BudgetLimitSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BudgetLimitSingle.parse_obj(obj)

        _obj = BudgetLimitSingle.parse_obj({
            "data": BudgetLimitRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
