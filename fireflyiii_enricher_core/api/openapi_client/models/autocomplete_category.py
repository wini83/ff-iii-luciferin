...
class AutocompleteCategory(BaseModel):
    ...
    """
    id: StrictStr = Field(...)
    name: StrictStr = Field(default=..., description="Name of the category found by an auto-complete search.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AutocompleteCategory:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AutocompleteCategory:
        """Create an instance of AutocompleteCategory from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AutocompleteCategory.parse_obj(obj)

        _obj = AutocompleteCategory.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name")
        })
        return _obj
