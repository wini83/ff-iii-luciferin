...
class BillStore(BaseModel):
    ...
    amount_min: StrictStr = Field(...)
    amount_max: StrictStr = Field(...)
    ...
    repeat_freq: BillRepeatFrequency = Field(...)
    ...
    __properties = ["currency_id", "currency_code", "name", "amount_min", "amount_max", "date", "end_date", "extension_date", "repeat_freq", "skip", "active", "notes", "object_group_id", "object_group_title"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillStore:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillStore:
        """Create an instance of BillStore from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillStore.parse_obj(obj)

        _obj = BillStore.parse_obj({
