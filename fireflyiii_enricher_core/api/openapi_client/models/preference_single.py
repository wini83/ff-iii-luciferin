...
class PreferenceSingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PreferenceSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PreferenceSingle:
        """Create an instance of PreferenceSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PreferenceSingle.parse_obj(obj)

        _obj = PreferenceSingle.parse_obj({
            "data": PreferenceRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
