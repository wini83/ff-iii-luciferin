...
class BillSingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillSingle:
        """Create an instance of BillSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillSingle.parse_obj(obj)

        _obj = BillSingle.parse_obj({
            "data": BillRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
