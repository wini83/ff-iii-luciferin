...
class TransactionLinkSingle(BaseModel):
    ...
    """
    data: TransactionLinkRead = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionLinkSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionLinkSingle:
        """Create an instance of TransactionLinkSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionLinkSingle.parse_obj(obj)

        _obj = TransactionLinkSingle.parse_obj({
            "data": TransactionLinkRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
