...
class AccountUpdate(BaseModel):
    ...
    currency_id: Optional[StrictStr] = Field(default=None, description="Use either currency_id or currency_code. Defaults to the user's financial administration's currency.")
    currency_code: Optional[StrictStr] = Field(default=None, description="Use either currency_id or currency_code. Defaults to the user's financial administration's currency.")
    ...
    __properties = ["name", "iban", "bic", "account_number", "opening_balance", "opening_balance_date", "virtual_balance", "currency_id", "currency_code", "active", "order", "include_net_worth", "account_role", "credit_card_type", "monthly_payment_date", "liability_type", "interest", "interest_period", "notes", "latitude", "longitude", "zoom_level"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountUpdate:
        """Create an instance of AccountUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccountUpdate.parse_obj(obj)

        _obj = AccountUpdate.parse_obj({
            "name": obj.get("name"),
            "iban": obj.get("iban"),
            "bic": obj.get("bic"),
