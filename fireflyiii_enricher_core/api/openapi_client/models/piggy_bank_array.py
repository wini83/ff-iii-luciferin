...
class PiggyBankArray(BaseModel):
    ...
    PiggyBankArray
    """
    data: conlist(PiggyBankRead) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PiggyBankArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PiggyBankArray:
        """Create an instance of PiggyBankArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PiggyBankArray.parse_obj(obj)

        _obj = PiggyBankArray.parse_obj({
            "data": [PiggyBankRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
