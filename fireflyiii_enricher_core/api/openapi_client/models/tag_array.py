...
class TagArray(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TagArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TagArray:
        """Create an instance of TagArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TagArray.parse_obj(obj)

        _obj = TagArray.parse_obj({
            "data": [TagRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
