...
class UserGroupArray(BaseModel):
    ...
    UserGroupArray
    """
    data: conlist(UserGroupRead) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserGroupArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserGroupArray:
        """Create an instance of UserGroupArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserGroupArray.parse_obj(obj)

        _obj = UserGroupArray.parse_obj({
            "data": [UserGroupRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
