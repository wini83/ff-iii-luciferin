...
class BudgetArray(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BudgetArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BudgetArray:
        """Create an instance of BudgetArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BudgetArray.parse_obj(obj)

        _obj = BudgetArray.parse_obj({
            "data": [BudgetRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
