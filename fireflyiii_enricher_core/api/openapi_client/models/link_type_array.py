...
class LinkTypeArray(BaseModel):
    ...
    LinkTypeArray
    """
    data: conlist(LinkTypeRead) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LinkTypeArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LinkTypeArray:
        """Create an instance of LinkTypeArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LinkTypeArray.parse_obj(obj)

        _obj = LinkTypeArray.parse_obj({
            "data": [LinkTypeRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
