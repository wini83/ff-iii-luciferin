...
class UserGroupRead(BaseModel):
    ...
    id: StrictStr = Field(...)
    attributes: UserGroupReadAttributes = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserGroupRead:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserGroupRead:
        """Create an instance of UserGroupRead from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserGroupRead.parse_obj(obj)

        _obj = UserGroupRead.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": UserGroupReadAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
