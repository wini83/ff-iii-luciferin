...
class CategorySingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CategorySingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CategorySingle:
        """Create an instance of CategorySingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CategorySingle.parse_obj(obj)

        _obj = CategorySingle.parse_obj({
            "data": CategoryRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
