...
class RuleTriggerStore(BaseModel):
    ...
    value: StrictStr = Field(default=..., description="The accompanying value the trigger responds to. This value is often mandatory, but this depends on the trigger.")
