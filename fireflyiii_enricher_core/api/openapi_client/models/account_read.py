...
class AccountRead(BaseModel):
    ...
    id: StrictStr = Field(...)
    attributes: AccountProperties = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountRead:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountRead:
        """Create an instance of AccountRead from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccountRead.parse_obj(obj)

        _obj = AccountRead.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": AccountProperties.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
