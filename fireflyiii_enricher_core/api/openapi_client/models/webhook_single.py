...
class WebhookSingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookSingle:
        """Create an instance of WebhookSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookSingle.parse_obj(obj)

        _obj = WebhookSingle.parse_obj({
            "data": WebhookRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
