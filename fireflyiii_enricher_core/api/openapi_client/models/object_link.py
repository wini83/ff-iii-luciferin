...
class ObjectLink(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectLink:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ObjectLink:
        """Create an instance of ObjectLink from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectLink.parse_obj(obj)

        _obj = ObjectLink.parse_obj({
            "var_self": obj.get("self"),
            "var_0": ObjectLink0.from_dict(obj.get("0")) if obj.get("0") is not None else None
        })
        return _obj
