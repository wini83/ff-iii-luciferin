...
class AvailableBudgetArray(BaseModel):
    ...
    """
    data: conlist(AvailableBudgetRead) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AvailableBudgetArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AvailableBudgetArray:
        """Create an instance of AvailableBudgetArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AvailableBudgetArray.parse_obj(obj)

        _obj = AvailableBudgetArray.parse_obj({
            "data": [AvailableBudgetRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
