...
class WebhookAttemptArray(BaseModel):
    ...
    WebhookAttemptArray
    """
    data: conlist(WebhookAttemptRead) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookAttemptArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookAttemptArray:
        """Create an instance of WebhookAttemptArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookAttemptArray.parse_obj(obj)

        _obj = WebhookAttemptArray.parse_obj({
            "data": [WebhookAttemptRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
