...
class RuleRead(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RuleRead:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RuleRead:
        """Create an instance of RuleRead from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RuleRead.parse_obj(obj)

        _obj = RuleRead.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": Rule.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
