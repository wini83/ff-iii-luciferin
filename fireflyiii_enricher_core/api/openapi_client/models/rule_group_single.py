...
class RuleGroupSingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RuleGroupSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RuleGroupSingle:
        """Create an instance of RuleGroupSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RuleGroupSingle.parse_obj(obj)

        _obj = RuleGroupSingle.parse_obj({
            "data": RuleGroupRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
