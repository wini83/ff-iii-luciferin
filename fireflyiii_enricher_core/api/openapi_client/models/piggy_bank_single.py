...
class PiggyBankSingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PiggyBankSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PiggyBankSingle:
        """Create an instance of PiggyBankSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PiggyBankSingle.parse_obj(obj)

        _obj = PiggyBankSingle.parse_obj({
            "data": PiggyBankRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
