...
class TagModelUpdate(BaseModel):
    ...
    var_date: Optional[date] = Field(default=None, alias="date", description="The date to which the tag is applicable.")
    ...
    __properties = ["tag", "date", "description", "latitude", "longitude", "zoom_level"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TagModelUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TagModelUpdate:
        """Create an instance of TagModelUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TagModelUpdate.parse_obj(obj)

        _obj = TagModelUpdate.parse_obj({
            "tag": obj.get("tag"),
