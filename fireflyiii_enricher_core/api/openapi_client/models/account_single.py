...
class AccountSingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountSingle:
        """Create an instance of AccountSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccountSingle.parse_obj(obj)

        _obj = AccountSingle.parse_obj({
            "data": AccountRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
