...
class AutocompleteTransactionType(BaseModel):
    ...
    """
    id: StrictStr = Field(...)
    name: StrictStr = Field(default=..., description="Type of the object found by an auto-complete search.")
    type: StrictStr = Field(default=..., description="Name of the object found by an auto-complete search.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AutocompleteTransactionType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AutocompleteTransactionType:
        """Create an instance of AutocompleteTransactionType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AutocompleteTransactionType.parse_obj(obj)

        _obj = AutocompleteTransactionType.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "type": obj.get("type")
        })
