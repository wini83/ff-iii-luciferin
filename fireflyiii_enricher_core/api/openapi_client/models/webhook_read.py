...
class WebhookRead(BaseModel):
    ...
    id: StrictStr = Field(...)
    attributes: WebhookProperties = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookRead:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookRead:
        """Create an instance of WebhookRead from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookRead.parse_obj(obj)

        _obj = WebhookRead.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": WebhookProperties.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
