...
class PreferenceRead(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PreferenceRead:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PreferenceRead:
        """Create an instance of PreferenceRead from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PreferenceRead.parse_obj(obj)

        _obj = PreferenceRead.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": Preference.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
