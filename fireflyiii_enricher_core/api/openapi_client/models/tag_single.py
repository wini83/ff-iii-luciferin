...
class TagSingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TagSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TagSingle:
        """Create an instance of TagSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TagSingle.parse_obj(obj)

        _obj = TagSingle.parse_obj({
            "data": TagRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
