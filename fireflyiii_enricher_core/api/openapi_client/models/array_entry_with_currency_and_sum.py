...
class ArrayEntryWithCurrencyAndSum(BaseModel):
    ...
    sum: Optional[StrictStr] = Field(default=None, description="The amount earned, spent or transferred.")
    __properties = ["currency_id", "currency_code", "currency_symbol", "currency_decimal_places", "sum"]
