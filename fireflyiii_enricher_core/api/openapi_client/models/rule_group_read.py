...
class RuleGroupRead(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RuleGroupRead:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RuleGroupRead:
        """Create an instance of RuleGroupRead from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RuleGroupRead.parse_obj(obj)

        _obj = RuleGroupRead.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": RuleGroup.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
