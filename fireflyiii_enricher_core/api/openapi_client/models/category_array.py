...
class CategoryArray(BaseModel):
    ...
    CategoryArray
    """
    data: conlist(CategoryRead) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CategoryArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CategoryArray:
        """Create an instance of CategoryArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CategoryArray.parse_obj(obj)

        _obj = CategoryArray.parse_obj({
            "data": [CategoryRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
