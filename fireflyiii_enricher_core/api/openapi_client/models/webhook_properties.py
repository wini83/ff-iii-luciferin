...
class WebhookProperties(BaseModel):
    ...
    title: StrictStr = Field(default=..., description="A title for the webhook for easy recognition.")
    ...
    url: StrictStr = Field(default=..., description="The URL of the webhook. Has to start with `https`.")
    __properties = ["created_at", "updated_at", "active", "title", "secret", "triggers", "responses", "deliveries", "url"]
