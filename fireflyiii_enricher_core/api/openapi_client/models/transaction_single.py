...
class TransactionSingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionSingle:
        """Create an instance of TransactionSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionSingle.parse_obj(obj)

        _obj = TransactionSingle.parse_obj({
            "data": TransactionRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
