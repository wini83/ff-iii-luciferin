...
class WebhookArray(BaseModel):
    ...
    WebhookArray
    """
    data: conlist(WebhookRead) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookArray:
        """Create an instance of WebhookArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookArray.parse_obj(obj)

        _obj = WebhookArray.parse_obj({
            "data": [WebhookRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
