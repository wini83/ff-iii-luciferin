...
class RuleArray(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RuleArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RuleArray:
        """Create an instance of RuleArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RuleArray.parse_obj(obj)

        _obj = RuleArray.parse_obj({
            "data": [RuleRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
