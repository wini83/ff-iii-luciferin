...
class AccountArray(BaseModel):
    ...
    AccountArray
    """
    data: conlist(AccountRead) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountArray:
        """Create an instance of AccountArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccountArray.parse_obj(obj)

        _obj = AccountArray.parse_obj({
            "data": [AccountRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
