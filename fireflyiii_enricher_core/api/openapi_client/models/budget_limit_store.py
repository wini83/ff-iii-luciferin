...
class BudgetLimitStore(BaseModel):
    ...
    BudgetLimitStore
    """
    currency_id: Optional[StrictStr] = Field(default=None, description="Use either currency_id or currency_code. Defaults to the user's primary currency.")
    currency_code: Optional[StrictStr] = Field(default=None, description="Use either currency_id or currency_code. Defaults to the user's primary currency.")
    budget_id: StrictStr = Field(default=..., description="The budget ID of the associated budget.")
    ...
    __properties = ["currency_id", "currency_code", "budget_id", "start", "period", "end", "amount", "notes", "fire_webhooks"]
