...
class UserSingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserSingle:
        """Create an instance of UserSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserSingle.parse_obj(obj)

        _obj = UserSingle.parse_obj({
            "data": UserRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
