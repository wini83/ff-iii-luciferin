...
class TransactionLink(BaseModel):
    ...
    link_type_id: StrictStr = Field(default=..., description="The link type ID to use. You can also use the link_type_name field.")
    ...
    inward_id: StrictStr = Field(default=..., description="The inward transaction transaction_journal_id for the link. This becomes the 'is paid by' transaction of the set.")
    outward_id: StrictStr = Field(default=..., description="The outward transaction transaction_journal_id for the link. This becomes the 'pays for' transaction of the set.")
    notes: Optional[StrictStr] = Field(default=None, description="Optional. Some notes.")
    __properties = ["created_at", "updated_at", "link_type_id", "link_type_name", "inward_id", "outward_id", "notes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionLink:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionLink:
        """Create an instance of TransactionLink from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionLink.parse_obj(obj)

        _obj = TransactionLink.parse_obj({
