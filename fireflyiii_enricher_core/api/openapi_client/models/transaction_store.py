...
class TransactionStore(BaseModel):
    ...
    __properties = ["error_if_duplicate_hash", "apply_rules", "fire_webhooks", "group_title", "transactions"]
    ...
    def from_dict(cls, obj: dict) -> TransactionStore:
        ...
        _obj = TransactionStore.parse_obj({
            ...
            "transactions": [TransactionSplitStore.from_dict(_item) for _item in obj.get("transactions")] if obj.get("transactions") is not None else None
        })
        return _obj
