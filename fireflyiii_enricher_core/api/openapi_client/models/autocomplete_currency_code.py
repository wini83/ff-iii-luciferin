...
class AutocompleteCurrencyCode(BaseModel):
    ...
    """
    id: StrictStr = Field(...)
    name: StrictStr = Field(default=..., description="Currency name with the code between brackets.")
    code: StrictStr = Field(default=..., description="Currency code.")
    symbol: StrictStr = Field(...)
    decimal_places: StrictInt = Field(...)
    __properties = ["id", "name", "code", "symbol", "decimal_places"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AutocompleteCurrencyCode:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AutocompleteCurrencyCode:
        """Create an instance of AutocompleteCurrencyCode from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AutocompleteCurrencyCode.parse_obj(obj)

        _obj = AutocompleteCurrencyCode.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "code": obj.get("code"),
