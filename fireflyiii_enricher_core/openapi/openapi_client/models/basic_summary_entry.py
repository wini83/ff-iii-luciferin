...
class BasicSummaryEntry(BaseModel):
    ...
    __properties = ["key", "title", "monetary_value", "currency_id", "currency_code", "currency_symbol", "currency_decimal_places", "no_available_budgets", "value_parsed", "local_icon", "sub_title"]
