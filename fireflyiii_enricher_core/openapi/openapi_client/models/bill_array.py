...
class BillArray(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillArray:
        """Create an instance of BillArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillArray.parse_obj(obj)

        _obj = BillArray.parse_obj({
            "data": [BillRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
