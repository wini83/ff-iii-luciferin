...
class TransactionLinkRead(BaseModel):
    ...
    id: StrictStr = Field(...)
    attributes: TransactionLink = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionLinkRead:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionLinkRead:
        """Create an instance of TransactionLinkRead from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionLinkRead.parse_obj(obj)

        _obj = TransactionLinkRead.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": TransactionLink.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
