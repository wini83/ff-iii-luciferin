...
class ObjectGroupArray(BaseModel):
    ...
    ObjectGroupArray
    """
    data: conlist(ObjectGroupRead) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectGroupArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ObjectGroupArray:
        """Create an instance of ObjectGroupArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectGroupArray.parse_obj(obj)

        _obj = ObjectGroupArray.parse_obj({
            "data": [ObjectGroupRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
