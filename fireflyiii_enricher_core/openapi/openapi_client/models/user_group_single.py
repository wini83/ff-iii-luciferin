...
class UserGroupSingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserGroupSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserGroupSingle:
        """Create an instance of UserGroupSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserGroupSingle.parse_obj(obj)

        _obj = UserGroupSingle.parse_obj({
            "data": UserGroupRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
