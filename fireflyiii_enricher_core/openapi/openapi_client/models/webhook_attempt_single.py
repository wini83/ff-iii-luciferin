...
class WebhookAttemptSingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookAttemptSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookAttemptSingle:
        """Create an instance of WebhookAttemptSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookAttemptSingle.parse_obj(obj)

        _obj = WebhookAttemptSingle.parse_obj({
            "data": WebhookAttemptRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
