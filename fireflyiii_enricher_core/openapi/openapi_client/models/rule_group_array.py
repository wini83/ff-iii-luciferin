...
class RuleGroupArray(BaseModel):
    ...
    RuleGroupArray
    """
    data: conlist(RuleGroupRead) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RuleGroupArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RuleGroupArray:
        """Create an instance of RuleGroupArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RuleGroupArray.parse_obj(obj)

        _obj = RuleGroupArray.parse_obj({
            "data": [RuleGroupRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
