...
class PiggyBankUpdate(BaseModel):
    ...
    __properties = ["name", "accounts", "currency_id", "currency_code", "target_amount", "start_date", "target_date", "order", "active", "notes", "object_group_id", "object_group_title"]
    ...
    def from_dict(cls, obj: dict) -> PiggyBankUpdate:
        ...
        _obj = PiggyBankUpdate.parse_obj({
            "name": obj.get("name"),
            "accounts": [PiggyBankAccountUpdate.from_dict(_item) for _item in obj.get("accounts")] if obj.get("accounts") is not None else None,
