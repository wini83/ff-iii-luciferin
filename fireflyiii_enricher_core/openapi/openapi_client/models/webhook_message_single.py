...
class WebhookMessageSingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookMessageSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookMessageSingle:
        """Create an instance of WebhookMessageSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookMessageSingle.parse_obj(obj)

        _obj = WebhookMessageSingle.parse_obj({
            "data": WebhookMessageRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
