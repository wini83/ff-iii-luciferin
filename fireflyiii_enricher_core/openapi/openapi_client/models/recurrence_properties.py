...
class RecurrenceProperties(BaseModel):
    ...
    __properties = ["created_at", "updated_at", "type", "title", "description", "first_date", "latest_date", "repeat_until", "apply_rules", "active", "nr_of_repetitions", "notes", "repetitions", "transactions"]
    ...
    def from_dict(cls, obj: dict) -> RecurrenceProperties:
        ...
        _obj = RecurrenceProperties.parse_obj({
            ...
            "notes": obj.get("notes"),
            "repetitions": [RecurrenceRepetition.from_dict(_item) for _item in obj.get("repetitions")] if obj.get("repetitions") is not None else None,
            "transactions": [RecurrenceTransaction.from_dict(_item) for _item in obj.get("transactions")] if obj.get("transactions") is not None else None
        })
        return _obj
