...
class ObjectGroupSingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObjectGroupSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ObjectGroupSingle:
        """Create an instance of ObjectGroupSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObjectGroupSingle.parse_obj(obj)

        _obj = ObjectGroupSingle.parse_obj({
            "data": ObjectGroupRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
