...
class BudgetLimitArray(BaseModel):
    ...
    BudgetLimitArray
    """
    data: conlist(BudgetLimitRead) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BudgetLimitArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BudgetLimitArray:
        """Create an instance of BudgetLimitArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BudgetLimitArray.parse_obj(obj)

        _obj = BudgetLimitArray.parse_obj({
            "data": [BudgetLimitRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
