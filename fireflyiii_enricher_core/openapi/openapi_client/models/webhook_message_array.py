...
class WebhookMessageArray(BaseModel):
    ...
    WebhookMessageArray
    """
    data: conlist(WebhookMessageRead) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookMessageArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookMessageArray:
        """Create an instance of WebhookMessageArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookMessageArray.parse_obj(obj)

        _obj = WebhookMessageArray.parse_obj({
            "data": [WebhookMessageRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
