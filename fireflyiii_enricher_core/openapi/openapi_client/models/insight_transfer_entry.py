...
class InsightTransferEntry(BaseModel):
    ...
    var_in: Optional[StrictStr] = Field(default=None, alias="in", description="The total amount transferred TO this account between start date and end date, a number defined as a string, for this asset account.")
    ...
    __properties = ["id", "name", "difference", "difference_float", "in", "in_float", "out", "out_float", "currency_id", "currency_code"]
