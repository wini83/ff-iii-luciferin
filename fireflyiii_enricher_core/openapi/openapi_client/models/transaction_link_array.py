...
class TransactionLinkArray(BaseModel):
    ...
    """
    data: conlist(TransactionLinkRead) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionLinkArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionLinkArray:
        """Create an instance of TransactionLinkArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionLinkArray.parse_obj(obj)

        _obj = TransactionLinkArray.parse_obj({
            "data": [TransactionLinkRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
