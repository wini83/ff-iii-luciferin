...
class RecurrenceSingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecurrenceSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecurrenceSingle:
        """Create an instance of RecurrenceSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecurrenceSingle.parse_obj(obj)

        _obj = RecurrenceSingle.parse_obj({
            "data": RecurrenceRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
