...
class CurrencyArray(BaseModel):
    ...
    CurrencyArray
    """
    data: conlist(CurrencyRead) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CurrencyArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CurrencyArray:
        """Create an instance of CurrencyArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CurrencyArray.parse_obj(obj)

        _obj = CurrencyArray.parse_obj({
            "data": [CurrencyRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
