...
class PreferenceArray(BaseModel):
    ...
    PreferenceArray
    """
    data: conlist(PreferenceRead) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PreferenceArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PreferenceArray:
        """Create an instance of PreferenceArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PreferenceArray.parse_obj(obj)

        _obj = PreferenceArray.parse_obj({
            "data": [PreferenceRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
