...
class WebhookMessageRead(BaseModel):
    ...
    id: StrictStr = Field(...)
    attributes: WebhookMessage = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookMessageRead:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookMessageRead:
        """Create an instance of WebhookMessageRead from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookMessageRead.parse_obj(obj)

        _obj = WebhookMessageRead.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": WebhookMessage.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
