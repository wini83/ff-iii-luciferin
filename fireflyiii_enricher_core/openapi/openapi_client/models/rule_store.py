...
class RuleStore(BaseModel):
    ...
    rule_group_id: StrictStr = Field(default=..., description="ID of the rule group under which the rule must be stored. Either this field or rule_group_title is mandatory.")
    ...
    __properties = ["title", "description", "rule_group_id", "rule_group_title", "order", "trigger", "active", "strict", "stop_processing", "triggers", "actions"]
    ...
    def from_dict(cls, obj: dict) -> RuleStore:
        ...
        _obj = RuleStore.parse_obj({
            ...
            "triggers": [RuleTriggerStore.from_dict(_item) for _item in obj.get("triggers")] if obj.get("triggers") is not None else None,
            "actions": [RuleActionStore.from_dict(_item) for _item in obj.get("actions")] if obj.get("actions") is not None else None
        })
        return _obj
