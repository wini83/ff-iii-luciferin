...
class RecurrenceTransactionStore(BaseModel):
    ...
    destination_id: StrictStr = Field(default=..., description="ID of the destination account.")
    ...
    __properties = ["description", "amount", "foreign_amount", "currency_id", "currency_code", "foreign_currency_id", "foreign_currency_code", "budget_id", "category_id", "source_id", "destination_id", "tags", "piggy_bank_id", "bill_id"]
