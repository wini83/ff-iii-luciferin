...
class CurrencyExchangeProperties(BaseModel):
    ...
    from_currency_name: Optional[StrictStr] = Field(default=None, description="Base currency name for this exchange rate entry.")
    ...
    to_currency_name: Optional[StrictStr] = Field(default=None, description="Destination currency name for this exchange rate entry.")
    ...
    var_date: Optional[datetime] = Field(default=None, alias="date", description="Date and time of the exchange rate.")
    __properties = ["created_at", "updated_at", "from_currency_id", "from_currency_name", "from_currency_code", "from_currency_symbol", "from_currency_decimal_places", "to_currency_id", "to_currency_name", "to_currency_code", "to_currency_symbol", "to_currency_decimal_places", "rate", "date"]
