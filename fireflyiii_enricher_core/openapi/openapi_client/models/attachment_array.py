...
class AttachmentArray(BaseModel):
    ...
    AttachmentArray
    """
    data: conlist(AttachmentRead) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttachmentArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttachmentArray:
        """Create an instance of AttachmentArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AttachmentArray.parse_obj(obj)

        _obj = AttachmentArray.parse_obj({
            "data": [AttachmentRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
