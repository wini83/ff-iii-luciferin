...
class TransactionSplitUpdate(BaseModel):
    ...
    var_date: Optional[datetime] = Field(default=None, alias="date", description="Date of the transaction")
    ...
    currency_id: Optional[StrictStr] = Field(default=None, description="Currency ID. Default is the source account's currency, or the user's financial administration's primary currency. Can be used instead of currency_code.")
    currency_code: Optional[StrictStr] = Field(default=None, description="Currency code. Default is the source account's currency, or the user's financial administration's primary currency. Can be used instead of currency_id.")
