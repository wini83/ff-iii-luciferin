...
class LinkTypeSingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LinkTypeSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LinkTypeSingle:
        """Create an instance of LinkTypeSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LinkTypeSingle.parse_obj(obj)

        _obj = LinkTypeSingle.parse_obj({
            "data": LinkTypeRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
