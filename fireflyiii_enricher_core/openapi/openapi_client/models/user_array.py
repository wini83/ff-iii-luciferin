...
class UserArray(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserArray:
        """Create an instance of UserArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserArray.parse_obj(obj)

        _obj = UserArray.parse_obj({
            "data": [UserRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
