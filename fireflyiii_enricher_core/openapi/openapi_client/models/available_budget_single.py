...
class AvailableBudgetSingle(BaseModel):
    ...
    """
    data: AvailableBudgetRead = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AvailableBudgetSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AvailableBudgetSingle:
        """Create an instance of AvailableBudgetSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AvailableBudgetSingle.parse_obj(obj)

        _obj = AvailableBudgetSingle.parse_obj({
            "data": AvailableBudgetRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
