...
class LinkTypeRead(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LinkTypeRead:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LinkTypeRead:
        """Create an instance of LinkTypeRead from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LinkTypeRead.parse_obj(obj)

        _obj = LinkTypeRead.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": LinkType.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
