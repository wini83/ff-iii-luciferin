...
class RecurrenceTransactionUpdate(BaseModel):
    ...
    __properties = ["id", "description", "amount", "foreign_amount", "currency_id", "currency_code", "foreign_currency_id", "budget_id", "category_id", "source_id", "destination_id", "tags", "piggy_bank_id", "bill_id"]
