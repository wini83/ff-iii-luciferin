...
class BudgetRead(BaseModel):
    ...
    id: StrictStr = Field(...)
    attributes: BudgetProperties = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BudgetRead:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BudgetRead:
        """Create an instance of BudgetRead from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BudgetRead.parse_obj(obj)

        _obj = BudgetRead.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": BudgetProperties.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
