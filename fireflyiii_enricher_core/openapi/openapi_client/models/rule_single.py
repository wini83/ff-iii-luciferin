...
class RuleSingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RuleSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RuleSingle:
        """Create an instance of RuleSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RuleSingle.parse_obj(obj)

        _obj = RuleSingle.parse_obj({
            "data": RuleRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
