...
class WebhookAttemptRead(BaseModel):
    ...
    id: StrictStr = Field(...)
    attributes: WebhookAttempt = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookAttemptRead:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookAttemptRead:
        """Create an instance of WebhookAttemptRead from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookAttemptRead.parse_obj(obj)

        _obj = WebhookAttemptRead.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "attributes": WebhookAttempt.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
