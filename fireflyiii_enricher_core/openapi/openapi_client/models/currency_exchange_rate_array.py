...
class CurrencyExchangeRateArray(BaseModel):
    ...
    """
    data: conlist(CurrencyExchangeRateRead) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CurrencyExchangeRateArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CurrencyExchangeRateArray:
        """Create an instance of CurrencyExchangeRateArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CurrencyExchangeRateArray.parse_obj(obj)

        _obj = CurrencyExchangeRateArray.parse_obj({
            "data": [CurrencyExchangeRateRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            "meta": Meta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "links": PageLink.from_dict(obj.get("links")) if obj.get("links") is not None else None
        })
        return _obj
