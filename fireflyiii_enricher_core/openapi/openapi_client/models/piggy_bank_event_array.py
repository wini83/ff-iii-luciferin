...
class PiggyBankEventArray(BaseModel):
    ...
    PiggyBankEventArray
    """
    data: conlist(PiggyBankEventRead) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PiggyBankEventArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PiggyBankEventArray:
        """Create an instance of PiggyBankEventArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PiggyBankEventArray.parse_obj(obj)

        _obj = PiggyBankEventArray.parse_obj({
            "data": [PiggyBankEventRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
