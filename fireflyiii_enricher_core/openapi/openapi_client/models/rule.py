...
class Rule(BaseModel):
    ...
    __properties = ["created_at", "updated_at", "title", "description", "rule_group_id", "rule_group_title", "order", "trigger", "active", "strict", "stop_processing", "triggers", "actions"]
    ...
    def from_dict(cls, obj: dict) -> Rule:
        ...
        _obj = Rule.parse_obj({
            ...
            "triggers": [RuleTrigger.from_dict(_item) for _item in obj.get("triggers")] if obj.get("triggers") is not None else None,
            "actions": [RuleAction.from_dict(_item) for _item in obj.get("actions")] if obj.get("actions") is not None else None
        })
        return _obj
