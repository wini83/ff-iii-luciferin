...
class BudgetSingle(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BudgetSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BudgetSingle:
        """Create an instance of BudgetSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BudgetSingle.parse_obj(obj)

        _obj = BudgetSingle.parse_obj({
            "data": BudgetRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
