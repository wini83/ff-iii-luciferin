...
class Configuration(BaseModel):
    ...
    Configuration
    """
    title: ConfigValueFilter = Field(...)
    value: PolymorphicProperty = Field(...)
    editable: StrictBool = Field(default=..., description="If this config variable can be edited by the user")
    __properties = ["title", "value", "editable"]
