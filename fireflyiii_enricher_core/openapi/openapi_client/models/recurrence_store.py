...
class RecurrenceStore(BaseModel):
    ...
    first_date: date = Field(default=..., description="First time the recurring transaction will fire. Must be after today.")
    repeat_until: Optional[date] = Field(default=..., description="Date until the recurring transaction can fire. Use either this field or repetitions.")
    ...
    __properties = ["type", "title", "description", "first_date", "repeat_until", "nr_of_repetitions", "apply_rules", "active", "notes", "repetitions", "transactions"]
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.nr_of_repetitions is None and "nr_of_repetitions" in self.__fields_set__:
    ...
    def from_dict(cls, obj: dict) -> RecurrenceStore:
        ...
        _obj = RecurrenceStore.parse_obj({
            ...
            "notes": obj.get("notes"),
            "repetitions": [RecurrenceRepetitionStore.from_dict(_item) for _item in obj.get("repetitions")] if obj.get("repetitions") is not None else None,
            "transactions": [RecurrenceTransactionStore.from_dict(_item) for _item in obj.get("transactions")] if obj.get("transactions") is not None else None
        })
        return _obj
