...
class AccountStore(BaseModel):
    ...
    __properties = ["name", "type", "iban", "bic", "account_number", "opening_balance", "opening_balance_date", "virtual_balance", "currency_id", "currency_code", "active", "order", "include_net_worth", "account_role", "credit_card_type", "monthly_payment_date", "liability_type", "liability_direction", "interest", "interest_period", "notes", "latitude", "longitude", "zoom_level"]
