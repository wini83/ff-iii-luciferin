...
class TransactionArray(BaseModel):
    ...
    TransactionArray
    """
    data: conlist(TransactionRead) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionArray:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionArray:
        """Create an instance of TransactionArray from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionArray.parse_obj(obj)

        _obj = TransactionArray.parse_obj({
            "data": [TransactionRead.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
