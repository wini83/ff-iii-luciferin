...
class PiggyBankAccountRead(BaseModel):
    ...
    __properties = ["account_id", "name", "current_amount", "pc_current_amount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PiggyBankAccountRead:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PiggyBankAccountRead:
        """Create an instance of PiggyBankAccountRead from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PiggyBankAccountRead.parse_obj(obj)

        _obj = PiggyBankAccountRead.parse_obj({
