...
class UserGroupReadAttributes(BaseModel):
    ...
    __properties = ["created_at", "updated_at", "in_use", "can_see_members", "title", "primary_currency_id", "primary_currency_code", "primary_currency_symbol", "primary_currency_decimal_places", "members"]
    ...
    def from_dict(cls, obj: dict) -> UserGroupReadAttributes:
        ...
        _obj = UserGroupReadAttributes.parse_obj({
            ...
            "members": [UserGroupReadMembers.from_dict(_item) for _item in obj.get("members")] if obj.get("members") is not None else None
        })
        return _obj
