...
class CurrencyExchangeRateSingle(BaseModel):
    ...
    """
    data: CurrencyExchangeRateRead = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CurrencyExchangeRateSingle:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CurrencyExchangeRateSingle:
        """Create an instance of CurrencyExchangeRateSingle from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CurrencyExchangeRateSingle.parse_obj(obj)

        _obj = CurrencyExchangeRateSingle.parse_obj({
            "data": CurrencyExchangeRateRead.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
